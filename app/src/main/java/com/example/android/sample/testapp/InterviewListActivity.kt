...
class InterviewListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val questionNo = arrayListOf<Int>() // 質問No
        val question = arrayListOf<String>() // 質問内容
        val answer = arrayListOf<String>() // 回答内容
        // パーツを取得
        val list = findViewById<GridView>(R.id.interviewList) // GridView「facilityList」のIDを取得
        ...
        queryInterviewData.findInBackground { objects, e ->
            if (e != null) {
                ...
                val adapterInterviewList = InterviewListAdapter(this, studentImage, studentName, studentSubject)
